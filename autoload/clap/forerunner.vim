...
function! clap#forerunner#process_cache_info(decoded) abort
  let g:__clap_forerunner_tempfile = a:decoded.tempfile
  let g:clap.display.initial_size = a:decoded.total
  call clap#state#refresh_matches_count_on_forerunner_done()
